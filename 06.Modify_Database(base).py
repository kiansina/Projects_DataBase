...
import pandas as pd
import math
df=pd.read_excel(r'C:\Users\sina.kian\Desktop\Work\Ariston Marco\Property Data Base Ariston 07.02.22.xlsx')
...
dh['Total PD']= dh.loc[0 : 258,['building', 'machinery', 'building & machinery', 'stock', 'improvement of third party goods', 'molds', 'stock/content']].sum(axis = 1)
dh['Total'] = dh.loc[0 : 258,['building', 'machinery', 'building & machinery', 'stock', 'contr. margin', 'improvement of third party goods', 'molds', 'stock/content']].sum(axis = 1)
